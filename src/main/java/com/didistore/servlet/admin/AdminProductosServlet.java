...
public class AdminProductosServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (idParam != null && !idParam.trim().isEmpty()) {
            ...
            List<Productos> productos = catalogProductosController.listarProductos();
            response.setStatus(HttpServletResponse.SC_OK);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            resultado.put("success", false);
            resultado.put("message", "Error al crear el producto");
            response.getWriter().write(gson.toJson(resultado));
        }
    }
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.setStatus(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
            resultado.put("success", false);
            resultado.put("message", "Error al actualizar el producto");
            response.getWriter().write(gson.toJson(resultado));
        }
    }
    ...
    protected void doDelete(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.setStatus(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
            resultado.put("success", false);
            resultado.put("message", "Error al eliminar el producto");
            response.getWriter().write(gson.toJson(resultado));
        }
    }
}