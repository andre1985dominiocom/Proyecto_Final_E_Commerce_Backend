 ...
 */
public class TokensRecuperacioDAOImpl implements ITokensRecuperacionDAO {
    ...
    public TokensRecuperacion consultarTokenPorHash(String tokenHash) {
        ...
        try (Connection con = Conexion.getConexion();
            ...
            System.err.println("Error al consultar token por valor: " + e.getMessage());
        }
        return token;
    }
    ...
    public TokensRecuperacion consultarTokenPorUsuario(int usuarioId) {
        ...
        String sql = "SELECT (usuario_ID, "
                ...
                + "fecha_expiracion,"
                + "usado,"
                + "intentos) FROM usuarios WHERE usuario_ID = ?";
        ...
        try (Connection con = Conexion.getConexion();
            ...
            System.err.println("Error al consultar token por ID: " + e.getMessage());
        }
        return token;
